...
int matrixMultiply(int argc, char **argv, int devID, sMatrixSize &matrix_size)
{
    ...
    float *h_CUBLAS = (float *) malloc(mem_size_C);
		...
		// TODO: cudaMalloc d_A, d_B, d_C and do what's necessary ...
    ...
    // CUBLAS version 2.0
    {
				// TODO: determine scaling factor alpha and beta to be used when calling cublasSgemm()
				const float alpha = 1.0;
				const float beta  = 0.0;

        cudaEvent_t start, stop;

				// TODO: create&setup cublas handle
				// search 'cublasHandle_t' and 'cublasCreate'
				cublasHandle_t handle;
				cublasCreate(&handle);

        //Perform warmup operation with cublas
        // TODO: you need to call a dummy cublasSgemm(???) to make sure this warm-up period is not counted for performance measurements
				cublasSgemm(handle,
					CUBLAS_OP_N,
					CUBLAS_OP_N,
					matrix_size.uiWB,
        ...
        for (int j = 0; j < nIter; j++)
        {
            ...
            // TODO: checkCudaErrors(cublasSgemm(???));
